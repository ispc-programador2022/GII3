...
def linkTodasPginas(pageLink):#consigo el link de todas las paginas de la web filmaffinity
    lista=[]
    for i in range(1, 2):#genero una lista con los LINK DE CADA PAGINA (para pruebas solo los link de las 1 primeras paginas para que no se trabe la pc)
...
dfCatalogo.to_csv('webScrapingNetflix.csv',encoding='utf-8')
